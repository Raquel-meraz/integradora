...
// ⬇️ Importa estilos y colores desde el archivo nuevo
...
// 👇 NUEVO: helpers para extraer campos de cliente/vehículo sin romper si cambian llaves
const pickStr = (...xs: any[]) =>
  xs.find((x) => typeof x === "string" && x.trim().length > 0) as string | undefined;
      ...
      <View style={{ flexDirection: "row", alignItems: "center", gap: 12, marginBottom: 12, flexWrap: "wrap" }}>
        ...
        <Pressable
          ...
          style={{
            ...
            borderRadius: 999,
            // sombrita suave inline para no tocar tus estilos globales
            shadowColor: "#000",
            shadowOpacity: 0.06,
            shadowRadius: 8,
